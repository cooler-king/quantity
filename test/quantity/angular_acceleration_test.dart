...
void main() {
  group('AngularAcceleration', () {
    test('constructors', () {
      AngularAcceleration q = new AngularAcceleration();
      ...
      q = new AngularAcceleration(radiansPerSecondSquared: 42, uncert: 0.001);
      ...
      q = new AngularAcceleration(degreesPerSecondSquared: 1);
