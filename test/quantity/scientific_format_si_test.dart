    ...
    group('format', () {
      ...
      group('format', () {
        test('real only; num; unicode', () {
          final ScientificFormatSI f1 = new ScientificFormatSI(unicode: true);
          expect(f1.format(1), '1.0');
      ...
      test('real only; Number; regular spaces', () {
        ...
        expect(f1.format(new Integer(12)), '1.2 x 10^1');
        expect(f1.format(new Integer(123)), '1.23 x 10^2');
        expect(f1.format(new Integer(1234)), '1.234 x 10^3');
        expect(f1.format(new Integer(12345)), '1.2345 x 10^4');
        expect(f1.format(new Integer(123456)), '1.234 56 x 10^5');
        expect(f1.format(new Integer(1234567)), '1.234 567 x 10^6');
        expect(f1.format(new Integer(12345678)), '1.234 567 8 x 10^7');
        expect(f1.format(new Integer(123456789)), '1.234 567 89 x 10^8');
        expect(f1.format(new Integer(1234567890)), '1.234 567 890 x 10^9');
        expect(f1.format(new Integer(12345678901)), '1.234 567 890 1 x 10^10');

        expect(f1.format(new Double(0)), '0.0');
        expect(f1.format(new Double(10.01)), '1.001 x 10^1');
        expect(f1.format(new Double(100.001)), '1.000 01 x 10^2');
        expect(f1.format(new Double(1000.0001)), '1.000 000 1 x 10^3');
        expect(f1.format(new Double(10000.00001)), '1.000 000 001 x 10^4');
      ...
      test('imaginary only; regular spaces', () {
        ...
        expect(f1.format(new Imaginary(12)), '1.2i x 10^1');
        expect(f1.format(new Imaginary(123)), '1.23i x 10^2');
        expect(f1.format(new Imaginary(1234)), '1.234i x 10^3');
        expect(f1.format(new Imaginary(12345)), '1.2345i x 10^4');
        expect(f1.format(new Imaginary(123456)), '1.234 56i x 10^5');
        expect(f1.format(new Imaginary(1234567)), '1.234 567i x 10^6');
        expect(f1.format(new Imaginary(12345678)), '1.234 567 8i x 10^7');
        expect(f1.format(new Imaginary(123456789)), '1.234 567 89i x 10^8');
        expect(f1.format(new Imaginary(1234567890)), '1.234 567 890i x 10^9');

        expect(f1.format(new Imaginary(0.0)), '0.0i');
        expect(f1.format(new Imaginary(10.01)), '1.001i x 10^1');
        expect(f1.format(new Imaginary(100.001)), '1.000 01i x 10^2');
        expect(f1.format(new Imaginary(1000.0001)), '1.000 000 1i x 10^3');
        expect(f1.format(new Imaginary(10000.00001)), '1.000 000 001i x 10^4');
      ...
      test('complex; regular spaces', () {
        ...
        expect(f1.format(new Complex.coeff(12, 21)), '1.2 x 10^1 + 2.1i x 10^1');
        expect(f1.format(new Complex.coeff(123, 321)), '1.23 x 10^2 + 3.21i x 10^2');
        expect(f1.format(new Complex.coeff(1234, 4321)), '1.234 x 10^3 + 4.321i x 10^3');
        expect(f1.format(new Complex.coeff(12345, 54321)), '1.2345 x 10^4 + 5.4321i x 10^4');
        expect(f1.format(new Complex.coeff(123456, 654321)), '1.234 56 x 10^5 + 6.543 21i x 10^5');
        expect(f1.format(new Complex.coeff(1234567, 7654321)), '1.234 567 x 10^6 + 7.654 321i x 10^6');
        expect(f1.format(new Complex.coeff(12345678, 87654321)), '1.234 567 8 x 10^7 + 8.765 432 1i x 10^7');
        expect(f1.format(new Complex.coeff(123456789, 987654321)), '1.234 567 89 x 10^8 + 9.876 543 21i x 10^8');
        ...
        expect(f1.format(new Complex.coeff(10.01, 11.22)), '1.001 x 10^1 + 1.122i x 10^1');
        expect(f1.format(new Complex.coeff(100.001, 111.222)), '1.000 01 x 10^2 + 1.112 22i x 10^2');
        expect(f1.format(new Complex.coeff(1000.0001, 1111.2222)), '1.000 000 1 x 10^3 + 1.111 222 2i x 10^3');
        expect(f1.format(new Complex.coeff(10000.00001, 11111.22222)), '1.000 000 001 x 10^4 + 1.111 122 222i x 10^4');
