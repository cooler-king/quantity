...
void main() {
  group('QuantityRange', () {
    test('constructors', () {
      final QuantityRange<Scalar> range = new QuantityRange<Scalar>(new Scalar(value: 5), new Scalar(value: 23.3));
    ...
    test('min/max values', () {
      ...
      final QuantityRange<Length> range2 = new QuantityRange<Length>(new Length(m: 10000), new Length(km: 1000));
      expect(areWithin(range2.minValue, new Length(km: 10), new Length(m: 0.001)), true);
      expect(range2.maxValue == new Length(km: 1000), true);
    });

    test('operator ==', () {
      final QuantityRange<Length> range1 = new QuantityRange<Length>(new Length(m: 6.5), new Length(m: 18.3));
      final QuantityRange<Length> range2 = new QuantityRange<Length>(new Length(m: 6.8), new Length(m: 21.3));
      final QuantityRange<Length> range3 = new QuantityRange<Length>(new Length(m: 6.5), new Length(m: 18.3));
