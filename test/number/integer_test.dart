...
void main() {
  group('Integer', () {
    ...
    test('operator ==', () {
      ...
      final c1 = Complex(Integer(42), Imaginary(0.0));
      // ignore: unrelated_type_equality_checks
      expect(d == c1, true);
      final c2 = Complex(Integer(42), Imaginary(0.1));
      // ignore: unrelated_type_equality_checks
      expect(d == c2, false);
      final c3 = Complex(Integer(41), Imaginary(0.0));
      // ignore: unrelated_type_equality_checks
      expect(d == c3, false);
    });
    ...
    test('operator -', () {
      ...
      // - Complex
      var cx = Complex(Double(2), Imaginary(9.6));
      diff = i - cx;
      expect(diff is Complex, true);
    ...
    test('operator /', () {
      ...
      var cx = Complex(Double(1), Imaginary(2));
      quot = Integer(4) / cx;
    ...
    test('operator ~/', () {
      ...
      // / Complex
      // (a + 0i) / (c + di) = (ac - adi) / (c^2 + d^2)
      final cx = Complex(Double(1), Imaginary(2));
      n = Integer(12) ~/ cx;
      expect(n is Complex, true);
      expect((n as Complex).real is Integer, true);
      expect((n as Complex).real, Integer(2));
    ...
    test('operator <', () {
      ...
      expect(Integer(-77) < Complex(Double(77.001), Imaginary(55)), true);
    ...
    test('operator >', () {
      ...
      expect(Integer(77) > Complex(Double(6.5), Imaginary(99)), true);
      expect(Integer(77) > Complex(Double(77.001), Imaginary(55)), false);
    ...
    test('operator >=', () {
      ...
      expect(Integer(-77) >= Imaginary(6), false);
      expect(Integer(77) >= Complex(Double(6.5), Imaginary(99)), true);
      expect(Integer(77) >= Complex(Double(77.00001), Imaginary(55)), false);
      expect(Integer(77) >= Complex(Double(77), Imaginary(55)), false);
      expect(Integer(77) >= Complex(Double(77), Imaginary(0)), true);
