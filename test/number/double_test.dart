...
void main() {
  group('Double', () {
    ...
    test('operator ==', () {
      ...
      final c1 = Complex(Double(42), Imaginary(0));
      // ignore: unrelated_type_equality_checks
      expect(d4 == c1, true);
    });
    ...
    test('operator >', () {
      ...
      expect(Double(77) > Complex(Double(6.5), Imaginary(99)), true);
      expect(Double(-77.7) > Complex(Double(6.5), Imaginary(99)), false);
    ...
    test('operator >=', () {
      ...
      expect(Double(-77) >= Imaginary(6), false);
      expect(Double(77) >= Complex(Double(6.5), Imaginary(99)), true);
      expect(Double(77) >= Complex(Double(77), Imaginary(99)), true);
      expect(Double(77) >= Complex(Double(77.0001), Imaginary(99)), false);
      expect(Double(-77.7) >= Complex(Double(6.5), Imaginary(99)), false);
    ...
    test('operator <', () {
      ...
      expect(Double(77) < Complex(Double(6.5), Imaginary(99)), false);
      expect(Double(-77.7) < Complex(Double(6.5), Imaginary(99)), true);
    ...
    test('operator <=', () {
      ...
      expect(Double(-77) <= Imaginary(6), true);
      expect(Double(77) <= Complex(Double(6.5), Imaginary(99)), false);
      expect(Double(77) <= Complex(Double(77), Imaginary(22)), true);
      expect(Double(-77.7) <= Complex(Double(6.5), Imaginary(99)), true);
