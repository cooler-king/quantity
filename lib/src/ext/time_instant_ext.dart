...
// ignore: non_constant_identifier_names
final TimeInstantUnits TDT = TimeInstantUnits('Terrestrial Dynamical Time',
    'TT', 'TDT', 'Terrestrial Dynamical Time', 1.0, false, -32.184);
...
// ignore: non_constant_identifier_names
final TimeInstantUnits UT1 = TimeInstantUnits('Universal Time (UT1)', 'UT1',
    'UT1', 'Universal Time (UT1)', 1.0, false, 0.0, (dynamic val) {
  final d = val is num
      ? val.toDouble()
      : val is Number
          ? val.toDouble()
...
// ignore: non_constant_identifier_names
final TimeInstantUnits UT2 = TimeInstantUnits('Universal Time (UT2)', 'UT2',
    'UT2', 'Universal Time (UT2)', 1.0, false, 0.0, (dynamic val) {
...
// ignore: non_constant_identifier_names
final TimeInstantUnits JD_TAI = TimeInstantUnits('Julian Date (TAI)', 'JD(TAI)',
    'JD(TAI)', 'Julian Date (TAI)', 86400.0, false, -2436204.5);

//__________________________________________________________________________________________________________

/// Modified Julian Date in the TAI scale
// ignore: non_constant_identifier_names
final TimeInstantUnits MJD_TAI = TimeInstantUnits(
    'Modified Julian Date (TAI)',
    'MJD(TAI)',
    'MJD(TAI)',
    'Modified Julian Date (TAI)',
    86400.0,
...
// ignore: non_constant_identifier_names
final TimeInstantUnits MJD_UTC = TimeInstantUnits(
...
// ignore: non_constant_identifier_names
final TimeInstantUnits MJD_UT1 = TimeInstantUnits(
...
// ignore: non_constant_identifier_names
final TimeInstantUnits JD_TDB = TimeInstantUnits('Julian Date (TDB)', 'JD(TDB)',
    'JD(TDB)', 'Julian Date (TDB)', 86400.0, false, -2436204.5, (dynamic val) {
  final d = val is num
      ? val.toDouble()
      : val is Number
          ? val.toDouble()
...
// ignore: non_constant_identifier_names
final TimeInstantUnits MJD_TDB = TimeInstantUnits(
    'Modified Julian Date (TDT)',
    'MJD(TDT)',
    'MJD(TDT)',
    'Modified Julian Date (TDT)',
...
// ignore: non_constant_identifier_names
final TimeInstantUnits JD_TCG = TimeInstantUnits('Julian Date (TCG)', 'JD(TCG)',
    'JD(TCG)', 'Julian Date (TCG)', 86400.0, false, -2436204.5, (dynamic val) {
  final d = val is num
      ? val.toDouble()
      : val is Number
          ? val.toDouble()
...
// ignore: non_constant_identifier_names
final TimeInstantUnits MJD_TCG = TimeInstantUnits(
    'Modified Julian Date (TCG)',
    'MJD(TCG)',
    'MJD(TCG)',
    'Modified Julian Date (TCG)',
    86400.0,
...
// ignore: non_constant_identifier_names
final TimeInstantUnits MJD_TCB = TimeInstantUnits(
    'Modified Julian Date (TCB)',
    'MJD(TCB)',
    'MJD(TCB)',
    'Modified Julian Date (TCB)',
    86400.0,
...
// ignore: non_constant_identifier_names
final TimeInstantUnits NTP = TimeInstantUnits('Network Time Protocol', 'NTP',
    'NTP', 'Network Time Protocol', 1.0, false, -1.8302976e9, (dynamic val) {
