...
final TimeUnits daysSidereal = TimeUnits('days (sidereal)', 'days (sid)',
    'days (sid)', 'day (sidereal)', 8.6164090e4, false);

/// A unit of one hour in the sidereal day.
final TimeUnits hoursSidereal = TimeUnits('hours (sidereal)', 'hr (sid)',
    'hr (sid)', 'hour (sidereal)', 3.5901704e3, false);

/// A unit of one minute in the sidereal day.
final TimeUnits minutesSidereal = TimeUnits('minutes (sidereal)', 'min (sid)',
    'min (sid)', 'minute (sidereal)', 5.9836174e1, false);

/// A unit of one second in the sidereal day.
final TimeUnits secondsSidereal = TimeUnits('seconds (sidereal)', 's (sid)',
    's (sid)', 'second (sidereal)', 9.9726957e-1, false);

/// Calendar years as a unit.
final TimeUnits yearsCalendar =
    TimeUnits('years', 'yr', 'yr', 'year', 3.1536e7, false);

/// Sidereal years as a unit.
final TimeUnits yearsSidereal = TimeUnits('years (sidereal)', 'yr (sid)',
    'yr (sid)', 'year (sidereal)', 3.1558150e7, false);

/// Tropical years as a unit.
final TimeUnits yearsTropical = TimeUnits('years (tropical)', 'yr (trop)',
...
final TimeUnits yearsJulian = TimeUnits('years (Julian)', 'yr (Jul)',
    'yr (Jul)', 'year (Julian)', 3.15576e7, false);

/// A unit of one billion years.
final TimeUnits aeons =
    TimeUnits('aeons', 'aeons', 'aeons', 'aeon', 3.1536e18, false);
