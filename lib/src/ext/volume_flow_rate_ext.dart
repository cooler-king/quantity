...
VolumeFlowRateUnits litersPerSecond =
    VolumeFlowRateUnits.volumePerTime(liters, seconds);

/// Shorthand synonym for liters per second.
VolumeFlowRateUnits lusecs = litersPerSecond;

/// The miner's inch as a unit.
VolumeFlowRateUnits minersInches = VolumeFlowRateUnits("miner's inch",
    "miner's inch", "miner's inch", "miner's inch", 7.07921e-4, false);
