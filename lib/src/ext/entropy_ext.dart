...
final EntropyUnits boltzmannUnit =
    EntropyUnits('Boltzmanns', 'kB', 'k', 'Boltzmann', 1.3806503e-23, false);

/// The erg per clausius unit of entropy.
final EntropyUnits clausius =
    EntropyUnits('Clausius', 'Cl', 'Cl', 'Clausius', 4.184, false);

/// The erg per kelvin unit of entropy.
final EntropyUnits ergPerKelvin =
    EntropyUnits.energyPerTemperature(ergs, TemperatureInterval.kelvins);
