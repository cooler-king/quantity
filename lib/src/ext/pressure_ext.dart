...
PressureUnits pascals = Pressure.pascals;
   ...
   PressureUnits atmospheres =
      new PressureUnits("atmospheres (std)",null,null,"atmosphere (std)",1.01325e5,false);
   ...
   PressureUnits baryes =
      new PressureUnits("baryes",null,null,null,1.0e-1,false);

   PressureUnits cmMercury0 =
      new PressureUnits("centimeters of mercury (0 deg C)",null,null,"centimeter of mercury (0 deg C)",1.33322e3,false);
   ...
   PressureUnits psi =
      new PressureUnits.forceArea(poundsForceAvoirdupois,squareInches);

   PressureUnits torrs =
      new PressureUnits("torrs",null,null,null,1.33322e2,false);

   /** A pressure often used as the reference pressure for calculation of
    *  sound pressure <b>levels</b>.
    **/
   ...
   PressureUnits referenceSoundWater =
      new PressureUnits("reference sound pressure (water)",null,null,"reference sound pressure (water)",1.0e-6,false);
