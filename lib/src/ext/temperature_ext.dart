...
final TemperatureUnits Fahrenheit = TemperatureUnits('degrees Fahrenheit', 'F',
    'F', 'degree Fahrenheit', fiveNinths, false, 273.15 - (fiveNinths * 32.0));

/// Rankine scale units.
// ignore:non_constant_identifier_names
final TemperatureUnits Rankine = TemperatureUnits('degrees Rankine', 'deg R',
    'deg R', 'degree Rankine', fiveNinths, false, 0);
