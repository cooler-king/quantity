...
final Scalar fineStructureConstant = new Scalar(value: 7.2973525698e-3, uncert: 3.2e-10);

/** proton g factor (gp) **/
final Scalar protonGFactor = new Scalar(value: 5.585694713, uncert: 8.2e-9);

/** electron g factor (ge) **/
final Scalar electronGFactor = new Scalar(value: -2.00231930436153, uncert: 2.6e-13);
