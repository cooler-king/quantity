...
class Permittivity extends Quantity {
  ...
  static const Dimensions permittivityDimensions = const Dimensions.constant(
      const {"Length": -3, "Time": 4, "Current": 2, "Mass": -1});

  /// The standard SI unit.
  static final PermittivityUnits faradsPerMeter =
      new PermittivityUnits.capacitanceLength(
          Capacitance.farads, Length.meters);

  Permittivity({dynamic F_per_m, double uncert: 0.0})
      : super(F_per_m != null ? F_per_m : 0.0, Permittivity.faradsPerMeter,
            uncert);

  Permittivity._internal(conv)
      : super._dimensions(conv, Permittivity.permittivityDimensions);
  ...
  Permittivity.inUnits(value, PermittivityUnits units, [double uncert = 0.0])
      : super(
            value, units != null ? units : Permittivity.faradsPerMeter, uncert);

  const Permittivity.constant(Number valueSI,
      {PermittivityUnits units, num uncert: 0.0})
      : super.constant(
