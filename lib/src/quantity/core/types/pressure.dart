...
class Pressure extends Quantity {
  ...
  static final PressureUnits pascals =
      new PressureUnits("pascals", null, "Pa", null, 1.0, true);

  /// Accepted for use with the SI, subject to further review.
  static final PressureUnits bars =
      new PressureUnits("bars", null, null, null, 1.0e5, true);

  Pressure({dynamic Pa, dynamic bars, double uncert: 0.0})
      : super(Pa != null ? Pa : (bars != null ? bars : 0.0),
            bars != null ? Pressure.bars : Pressure.pascals, uncert);

  Pressure._internal(conv)
      : super._dimensions(conv, Pressure.pressureDimensions);
  ...
  const Pressure.constant(Number valueSI,
      {PressureUnits units, num uncert: 0.0})
