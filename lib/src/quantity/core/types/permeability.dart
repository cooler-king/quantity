...
class Permeability extends Quantity {
  ...
  Permeability({dynamic H_per_m, dynamic N_per_A2, double uncert: 0.0}) : super(
...
class PermeabilityUnits extends Permeability with Units {
  ...
  Units derive(String fullPrefix, String abbrevPrefix, double conv) {
    return new PermeabilityUnits("${fullPrefix}${name}", _abbrev1 != null ? "${abbrevPrefix}${_abbrev1}" : null,
