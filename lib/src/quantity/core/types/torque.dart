...
class Torque extends Quantity {
  ...
  static const Dimensions torqueDimensions = const Dimensions.constant(
      const {"Length": 2, "Time": -2, "Mass": 1, "Angle": -1});
  ...
  static final TorqueUnits newtonMeters =
      new TorqueUnits.forceLength(Force.newtons, Length.meters);

  Torque({dynamic Nm, double uncert: 0.0})
      : super(Nm != null ? Nm : 0.0, Torque.newtonMeters, uncert);
