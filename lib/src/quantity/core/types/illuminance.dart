...
class Illuminance extends Quantity {
  ...
  static const Dimensions illuminanceDimensions = const Dimensions.constant(
      const {"Length": -2, "Intensity": 1, "Solid Angle": 1});

  /// The standard SI unit.
  // Note: singular same as plural
  static final IlluminanceUnits lux =
      new IlluminanceUnits("lux", null, "lx", "lux", 1.0, true);

  Illuminance({dynamic lux, double uncert: 0.0})
      : super(lux != null ? lux : 0.0, Illuminance.lux, uncert);

  Illuminance._internal(conv)
      : super._dimensions(conv, Illuminance.illuminanceDimensions);
  ...
  const Illuminance.constant(Number valueSI,
      {IlluminanceUnits units, num uncert: 0.0})
      : super.constant(
...
class IlluminanceUnits extends Illuminance with Units {
  IlluminanceUnits(String name, String abbrev1, String abbrev2, String singular,
      dynamic conv,
