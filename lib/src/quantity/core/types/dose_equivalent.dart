...
class DoseEquivalent extends Quantity {
  ...
  DoseEquivalent({dynamic Sv, dynamic rems, double uncert: 0.0}) : super(Sv != null ? Sv : (rems != null ? rems : 0.0),
...
class DoseEquivalentUnits extends DoseEquivalent with Units {
  ...
  Units derive(String fullPrefix, String abbrevPrefix, double conv) {
    return new DoseEquivalentUnits("${fullPrefix}${name}", _abbrev1 != null ? "${abbrevPrefix}${_abbrev1}" : null,
