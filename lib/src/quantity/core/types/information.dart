...
class Information extends Quantity {
  ...
  static final InformationUnits bits =
      new InformationUnits("bits", null, "bit", null, 1.0, true);

  /// Equal to 4 bits
  static final InformationUnits nibbles =
      new InformationUnits("nibbles", null, null, null, 4.0, false);

  /// Equal to 8 bits
  static final InformationUnits bytes =
      new InformationUnits("bytes", null, "B", null, 8.0, false);
  ...
  static final InformationUnits kilobytes =
      new InformationUnits("kilobytes", "kB", "KB", null, 8.0 * 1024.0, false);
  ...
  /// common usage (e.g., for data storage units). **/
  static final InformationUnits megabytes = new InformationUnits(
      "megabytes", null, "MB", null, 8.0 * 1.048576e6, false);
  ...
  /// common usage (e.g., for data storage units). **/
  static final InformationUnits gigabytes = new InformationUnits(
      "gigabytes", null, "GB", null, 8.0 * 1.073741824e9, false);
  ...
  /// common usage (e.g., for data storage units). **/
  static final InformationUnits terabytes = new InformationUnits(
      "terabytes", null, "TB", null, 8.0 * 1.099511627776e12, false);
  ...
  /// common usage (e.g., for data storage units). **/
  static final InformationUnits petabytes = new InformationUnits(
      "petabytes", null, "PB", null, 8.0 * 1.125899906842624e15, false);
  ...
  /// common usage (e.g., for data storage units). **/
  static final InformationUnits EXABYTES = new InformationUnits(
      "exabytes", null, "EB", null, 8.0 * 1.152921504606846976e18, false);

  Information({dynamic Bq, dynamic Ci, double uncert: 0.0})
      : super(Bq != null ? Bq : (Ci != null ? Ci : 0.0), Information.bits,
            uncert);

  Information._internal(conv)
      : super._dimensions(conv, Information.informationDimensions);
  ...
  const Information.constant(Number valueSI,
      {InformationUnits units, num uncert: 0.0})
      : super.constant(
...
class InformationUnits extends Information with Units {
  InformationUnits(String name, String abbrev1, String abbrev2, String singular,
      dynamic conv,
