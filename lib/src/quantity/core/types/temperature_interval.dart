...
class TemperatureInterval extends Quantity {
  ...
  TemperatureInterval({dynamic K, dynamic degC, double uncert: 0.0}) : super(
...
class TemperatureIntervalUnits extends TemperatureInterval with Units {
  ...
  Units derive(String fullPrefix, String abbrevPrefix, double conv) {
    return new TemperatureIntervalUnits("${fullPrefix}${name}", _abbrev1 != null ? "${abbrevPrefix}${_abbrev1}" : null,
