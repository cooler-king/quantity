...
class Area extends Quantity {
  ...
  Area.fromLengths(Length l1, Length l2)
      : super(l1.valueSI * l2.valueSI, Area.squareMeters,
            Math.sqrt(l1._ur * l1._ur + l2._ur * l2._ur));
}
...
class AreaUnits extends Area with Units {
  ...
  AreaUnits.lengthSquared(LengthUnits lu)
      : super._internal(lu.valueSI * lu.valueSI) {
    this.name = "square ${lu.name}";
    this.singular = "square ${lu.singular}";
    this._convToMKS = lu.valueSI * lu.valueSI;
    this._abbrev1 =
        lu._abbrev1 != null && lu._abbrev1 != null ? "${lu._abbrev1}2" : null;
    this._abbrev2 =
        lu._abbrev2 != null && lu._abbrev2 != null ? "${lu._abbrev2}2" : null;
    ;
