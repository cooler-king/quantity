...
class Capacitance extends Quantity {
  ...
  static const Dimensions electricCapacitanceDimensions =
      const Dimensions.constant(
          const {"Time": 4, "Current": 2, "Length": -2, "Mass": -1});

  /// The standard SI unit.
  static final CapacitanceUnits farads =
      new CapacitanceUnits("farads", null, "F", null, 1.0, true);

  Capacitance({dynamic F, double uncert: 0.0})
      : super(F != null ? F : 0.0, Capacitance.farads, uncert);

  Capacitance._internal(conv)
      : super._dimensions(conv, Capacitance.electricCapacitanceDimensions);
  ...
  const Capacitance.constant(Number valueSI,
      {CapacitanceUnits units, num uncert: 0.0})
      : super.constant(
...
class CapacitanceUnits extends Capacitance with Units {
  CapacitanceUnits(String name, String abbrev1, String abbrev2, String singular,
      dynamic conv,
