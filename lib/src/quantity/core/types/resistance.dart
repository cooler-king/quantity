...
class Resistance extends Quantity {
  ...
  static final ResistanceUnits ohms =
      new ResistanceUnits("ohms", "\u2126", "\u03a9", null, 1.0, true);

  Resistance({dynamic ohms, double uncert: 0.0})
      : super(ohms != null ? ohms : 0.0, Resistance.ohms, uncert);

  Resistance._internal(conv)
      : super._dimensions(conv, Resistance.electricResistanceDimensions);
  ...
  const Resistance.constant(Number valueSI,
      {ResistanceUnits units, num uncert: 0.0})
      : super.constant(
...
class ResistanceUnits extends Resistance with Units {
  ResistanceUnits(String name, String abbrev1, String abbrev2, String singular,
      dynamic conv,
