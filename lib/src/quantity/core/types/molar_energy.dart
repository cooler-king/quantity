...
class MolarEnergy extends Quantity {
  ...
  static const Dimensions molarEnergyDimensions = const Dimensions.constant(
      const {"Mass": 1, "Length": 2, "Time": -2, "Amount": -1});
  ...
  MolarEnergy({dynamic J_per_mol, double uncert: 0.0})
      : super(J_per_mol != null ? J_per_mol : 0.0, MolarEnergy.joulesPerMole,
            uncert);

  MolarEnergy._internal(conv)
      : super._dimensions(conv, MolarEnergy.molarEnergyDimensions);
  ...
  const MolarEnergy.constant(Number valueSI,
      {MolarEnergyUnits units, num uncert: 0.0})
      : super.constant(
...
class MolarEnergyUnits extends MolarEnergy with Units {
  MolarEnergyUnits(String name, String abbrev1, String abbrev2, String singular,
      dynamic conv,
  ...
  MolarEnergyUnits.energyAmount(EnergyUnits eu, AmountOfSubstanceUnits aosu)
    ...
    this._abbrev1 = eu._abbrev1 != null && aosu._abbrev1 != null
        ? "${eu._abbrev1} / ${aosu._abbrev1}"
        : null;
    this._abbrev2 = eu._abbrev2 != null && aosu._abbrev2 != null
        ? "${eu._abbrev2}${aosu._abbrev2}"
        : null;
