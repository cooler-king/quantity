...
class Concentration extends Quantity {
  ...
  static const Dimensions concentrationDimensions =
      const Dimensions.constant(const {"Amount": 1, "Length": -3});

  /// The standard SI unit **/
  static final ConcentrationUnits molesPerCubicMeter =
      new ConcentrationUnits.amountVolume(
  ...
  Concentration({dynamic rad_per_s2, dynamic deg_per_s2, double uncert: 0.0})
      : super(
            ...
            Concentration.molesPerCubicMeter,
            uncert);

  Concentration._internal(conv)
      : super._dimensions(conv, Concentration.concentrationDimensions);
  ...
  Concentration.inUnits(value, ConcentrationUnits units, [double uncert = 0.0])
      : super(value, units != null ? units : Concentration.molesPerCubicMeter,
            uncert);

  const Concentration.constant(Number valueSI,
      {ConcentrationUnits units, num uncert: 0.0})
      : super.constant(
...
class ConcentrationUnits extends Concentration with Units {
  ...
  ConcentrationUnits.amountVolume(AmountOfSubstanceUnits asu, VolumeUnits vu)
    ...
    this._abbrev1 = asu._abbrev1 != null && vu._abbrev1 != null
        ? "${asu._abbrev1} / ${vu._abbrev1}"
        : null;
    this._abbrev2 = asu._abbrev2 != null && vu._abbrev2 != null
        ? "${asu._abbrev2}/${vu._abbrev2}"
        : null;
    ;
