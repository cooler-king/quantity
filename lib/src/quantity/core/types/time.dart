...
class Time extends Quantity {
  ...
  static final TimeUnits seconds =
      new TimeUnits("seconds", "sec", "s", null, Double.one, true);

  /// accepted for use with the SI
  static final TimeUnits daysMeanSolar = new TimeUnits(
      "days", "days", "d", null, const Double.constant(8.64e4), false);

  /// accepted for use with the SI
  static final TimeUnits hoursMeanSolar = new TimeUnits(
      "hours", "hrs", "h", null, const Double.constant(3.60e3), false);

  /// accepted for use with the SI
  static final TimeUnits minutesMeanSolar = new TimeUnits(
      "minutes", "minutes", "min", null, const Double.constant(6.0e1), false);
  ...
  Time.fromDuration(Duration d)
      : super((d != null) ? d.inMicroseconds.toDouble() / 1.0e6 : 0.0,
            Time.seconds);
  ...
  ///
  Duration toDuration() =>
      new Duration(microseconds: (valueSI.toDouble() * 1000000.0).round());
}
