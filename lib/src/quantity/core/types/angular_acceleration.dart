...
class AngularAcceleration extends Quantity {
  ...
  AngularAcceleration({dynamic rad_per_s2, dynamic deg_per_s2, double uncert: 0.0}) : super(
          rad_per_s2 != null ? rad_per_s2 : (deg_per_s2 != null ? deg_per_s2 : 0.0),
...
class AngularAccelerationUnits extends AngularAcceleration with Units {
  ...
  Units derive(String fullPrefix, String abbrevPrefix, double conv) {
    return new AngularAccelerationUnits("${fullPrefix}${name}", _abbrev1 != null ? "${abbrevPrefix}${_abbrev1}" : null,
