...
class AngularAcceleration extends Quantity {
  ...
  static const Dimensions angularAccelerationDimensions =
      const Dimensions.constant(const {"Angle": 1, "Time": -2});
  ...
  AngularAcceleration(
      {dynamic rad_per_s2, dynamic deg_per_s2, double uncert: 0.0})
      : super(
            rad_per_s2 != null
                ? rad_per_s2
  ...
  AngularAcceleration._internal(conv)
      : super._dimensions(
            conv, AngularAcceleration.angularAccelerationDimensions);

  /// Constructs a AngularAcceleration based on the [value]
  /// and the conversion factor intrinsic to the passed [units].
  ///
  AngularAcceleration.inUnits(value, AngularAccelerationUnits units,
      [double uncert = 0.0])
      : super(
            value,
            units != null ? units : AngularAcceleration.radianPerSecondSquared,
            uncert);

  const AngularAcceleration.constant(Number valueSI,
      {AngularAccelerationUnits units, num uncert: 0.0})
