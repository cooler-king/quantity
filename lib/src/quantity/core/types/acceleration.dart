...
class Acceleration extends Quantity {
  ...
  static const Dimensions accelerationDimensions =
      const Dimensions.constant(const {"Length": 1, "Time": -2});
  ...
  Acceleration({dynamic m_per_s2, double uncert: 0.0})
      : super(m_per_s2 != null ? m_per_s2 : 0.0,
            Acceleration.meterPerSecondSquared, uncert);

  Acceleration._internal(conv)
      : super._dimensions(conv, Acceleration.accelerationDimensions);
  ...
  Acceleration.inUnits(value, AccelerationUnits units, [double uncert = 0.0])
      : super(value, units != null ? units : Acceleration.meterPerSecondSquared,
            uncert);

  const Acceleration.constant(Number valueSI,
      {AccelerationUnits units, num uncert: 0.0})
      : super.constant(
...
class AccelerationUnits extends Acceleration with Units {
  ...
  AccelerationUnits.lengthTimeUnits(LengthUnits lu, TimeUnits su)
      : super._internal(lu.valueSI * su.valueSI) {
    ...
    this._abbrev1 = lu._abbrev1 != null && su._abbrev1 != null
        ? "${lu._abbrev1} / ${su._abbrev1}"
        : null;
    this._abbrev2 = lu._abbrev2 != null && su._abbrev2 != null
        ? "${lu._abbrev2}${su._abbrev2}"
        : null;
    ;
    this.metricBase = metricBase;
    this.offset = offset;
