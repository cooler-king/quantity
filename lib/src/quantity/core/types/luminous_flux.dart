...
class LuminousFlux extends Quantity {
  ...
  static const Dimensions luminousFluxDimensions =
      const Dimensions.constant(const {"Intensity": 1, "Solid Angle": 1});

  /// The standard SI unit.
  static final LuminousFluxUnits lumens =
      new LuminousFluxUnits("lumens", null, "lm", null, 1.0, true);

  LuminousFlux({dynamic lm, double uncert: 0.0})
      : super(lm != null ? lm : 0.0, LuminousFlux.lumens, uncert);

  LuminousFlux._internal(conv)
      : super._dimensions(conv, LuminousFlux.luminousFluxDimensions);
  ...
  const LuminousFlux.constant(Number valueSI,
      {LuminousFluxUnits units, num uncert: 0.0})
      : super.constant(
