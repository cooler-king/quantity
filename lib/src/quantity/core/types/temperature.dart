...
class Temperature extends Quantity {
  ...
  Temperature({dynamic K, dynamic C, double uncert: 0.0}) : super(
          K != null ? K : (C != null ? C : 0.0), C != null ? Temperature.degreesCelsius : Temperature.kelvins, uncert);
...
class TemperatureUnits extends Temperature with Units {
  ...
  Units derive(String fullPrefix, String abbrevPrefix, double conv) {
    return new TemperatureUnits("${fullPrefix}${name}", _abbrev1 != null ? "${abbrevPrefix}${_abbrev1}" : null,
