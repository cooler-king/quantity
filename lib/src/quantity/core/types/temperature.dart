...
class Temperature extends Quantity {
  ...
  static const Dimensions temperatureDimensions =
      const Dimensions.constant(const {"Temperature": 1});

  // Units

  /// The standard SI unit.
  static final TemperatureUnits kelvins =
      new TemperatureUnits("kelvins", "K", null, null, Double.one, true, 0.0);

  /// Derived SI unit.
  static final TemperatureUnits degreesCelsius = new TemperatureUnits(
      "degrees Celsius",
      "deg C",
      null,
      "degree Celsius",
  ...
  Temperature({dynamic K, dynamic C, double uncert: 0.0})
      : super(
            K != null ? K : (C != null ? C : 0.0),
            C != null ? Temperature.degreesCelsius : Temperature.kelvins,
            uncert);

  Temperature._internal(conv)
      : super._dimensions(conv, Temperature.temperatureDimensions);
  ...
  const Temperature.constant(Number valueSI,
      {TemperatureUnits units, num uncert: 0.0})
      : super.constant(
...
class TemperatureUnits extends Temperature with Units {
  TemperatureUnits(String name, String abbrev1, String abbrev2, String singular,
      dynamic conv,
