...
class Frequency extends Quantity {
  ...
  Frequency({dynamic Hz, dynamic kHz, dynamic MHz, double uncert: 0.0}) : super(
...
class FrequencyUnits extends Frequency with Units {
  ...
  Units derive(String fullPrefix, String abbrevPrefix, double conv) {
    return new FrequencyUnits("${fullPrefix}${name}", _abbrev1 != null ? "${abbrevPrefix}${_abbrev1}" : null,
