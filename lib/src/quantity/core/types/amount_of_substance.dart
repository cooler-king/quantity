...
class AmountOfSubstance extends Quantity {
  ...
  static const Dimensions amountOfSubstanceDimensions =
      const Dimensions.constant(const {"Amount": 1});

  /// The standard SI unit.
  static final AmountOfSubstanceUnits moles =
      new AmountOfSubstanceUnits("moles", null, "mol", null, 1.0, true);
  ...
  AmountOfSubstance({dynamic mol, dynamic kmol, double uncert: 0.0})
      : super(
            mol != null ? mol : (kmol != null ? kmol : 0.0),
            kmol != null
                ? AmountOfSubstance.kilomoles
                : AmountOfSubstance.moles,
            uncert);

  AmountOfSubstance._internal(conv)
      : super._dimensions(conv, AmountOfSubstance.amountOfSubstanceDimensions);

  /// Constructs a AmountOfSubstance based on the [value]
  /// and the conversion factor intrinsic to the passed [units].
  ///
  AmountOfSubstance.inUnits(value, AmountOfSubstanceUnits units,
      [double uncert = 0.0])
      : super(value, units != null ? units : AmountOfSubstance.moles, uncert);

  const AmountOfSubstance.constant(Number valueSI,
      {AmountOfSubstanceUnits units, num uncert: 0.0})
