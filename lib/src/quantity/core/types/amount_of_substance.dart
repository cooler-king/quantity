...
class AmountOfSubstance extends Quantity {
  ...
  AmountOfSubstance({dynamic mol, dynamic kmol, double uncert: 0.0}) : super(
...
class AmountOfSubstanceUnits extends AmountOfSubstance with Units {
  ...
  Units derive(String fullPrefix, String abbrevPrefix, double conv) {
    return new AmountOfSubstanceUnits("${fullPrefix}${name}", _abbrev1 != null ? "${abbrevPrefix}${_abbrev1}" : null,
