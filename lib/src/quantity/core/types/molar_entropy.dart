...
class MolarEntropy extends Quantity {
  ...
  static final MolarEntropyUnits joulesPerMoleKelvin =
      new MolarEntropyUnits.energyAmountTemperature(
          Energy.joules, AmountOfSubstance.moles, TemperatureInterval.kelvins);

  MolarEntropy({dynamic J_per_molK, double uncert: 0.0})
      : super(J_per_molK != null ? J_per_molK : 0.0,
            MolarEntropy.joulesPerMoleKelvin, uncert);

  MolarEntropy._internal(conv)
      : super._dimensions(conv, MolarEntropy.molarEntropyDimensions);
  ...
  MolarEntropy.inUnits(value, MolarEntropyUnits units, [double uncert = 0.0])
      : super(value, units != null ? units : MolarEntropy.joulesPerMoleKelvin,
            uncert);

  const MolarEntropy.constant(Number valueSI,
      {MolarEntropyUnits units, num uncert: 0.0})
      : super.constant(
...
class MolarEntropyUnits extends MolarEntropy with Units {
  ...
  MolarEntropyUnits.energyAmountTemperature(
    ...
    this._abbrev1 = eu._abbrev1 != null && aosu._abbrev1 != null
        ? "${eu._abbrev1} / ${aosu._abbrev1} ${tu._abbrev1}"
        : null;
    this._abbrev2 = eu._abbrev2 != null && aosu._abbrev2 != null
        ? "${eu._abbrev2}/${aosu._abbrev2}${tu._abbrev2}"
        : null;
