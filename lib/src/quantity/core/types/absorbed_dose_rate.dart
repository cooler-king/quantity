...
class AbsorbedDoseRate extends Quantity {
  ...
  static const Dimensions ABSORBED_DOSE_RATE_DIMENSIONS =
      const Dimensions.constant(const {"Length": 2, "Time": -3});

  /// The standard SI unit.
  static final AbsorbedDoseRateUnits grayPerSecond =
      new AbsorbedDoseRateUnits.absorbedDoseTime(
  ...
  AbsorbedDoseRate({dynamic Gy_per_s, dynamic rads_per_s, double uncert: 0.0})
      : super(
            Gy_per_s != null
                ? Gy_per_s
                : (rads_per_s != null ? rads_per_s : 0.0),
            rads_per_s != null
                ? AbsorbedDoseRate.radsPerSecond
                : AbsorbedDoseRate.grayPerSecond,
            uncert);

  AbsorbedDoseRate._internal(conv)
      : super._dimensions(conv, AbsorbedDoseRate.ABSORBED_DOSE_RATE_DIMENSIONS);

  /// Constructs a AbsorbedDoseRate based on the [value]
  /// and the conversion factor intrinsic to the passed [units].
  ///
  AbsorbedDoseRate.inUnits(value, AbsorbedDoseRateUnits units,
      [double uncert = 0.0])
      : super(value, units != null ? units : AbsorbedDoseRate.grayPerSecond,
            uncert);

  const AbsorbedDoseRate.constant(Number valueSI,
      {AbsorbedDoseRateUnits units, num uncert: 0.0})
      : super.constant(valueSI, AbsorbedDoseRate.ABSORBED_DOSE_RATE_DIMENSIONS,
            units, uncert);
}
...
class AbsorbedDoseRateUnits extends AbsorbedDoseRate with Units {
  ...
  AbsorbedDoseRateUnits.absorbedDoseTime(AbsorbedDoseUnits adu, TimeUnits tu)
    ...
    this._abbrev1 = adu._abbrev1 != null && tu._abbrev1 != null
        ? "${adu._abbrev1} / ${tu._abbrev1}"
        : null;
    this._abbrev2 = adu._abbrev2 != null && tu._abbrev2 != null
        ? "${adu._abbrev2}${tu._abbrev2}"
        : null;
    ;
    this.metricBase = metricBase;
    this.offset = offset;
