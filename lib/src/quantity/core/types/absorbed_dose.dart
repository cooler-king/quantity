...
class AbsorbedDose extends Quantity {
  ...
  static final AbsorbedDoseUnits grays =
      new AbsorbedDoseUnits("grays", null, "Gy", null, 1.0, true);
  ...
  static final AbsorbedDoseUnits rads =
      new AbsorbedDoseUnits("rads", null, null, "rads", 1.0e-2, true);

  AbsorbedDose({dynamic Gy, dynamic rads, double uncert: 0.0})
      : super(Gy != null ? Gy : (rads != null ? rads : 0.0),
            rads != null ? AbsorbedDose.rads : AbsorbedDose.grays, uncert);

  AbsorbedDose._internal(conv)
      : super._dimensions(conv, AbsorbedDose.absorbedDoseDimensions);
  ...
  const AbsorbedDose.constant(Number valueSI,
      {AbsorbedDoseUnits units, num uncert: 0.0})
      : super.constant(
