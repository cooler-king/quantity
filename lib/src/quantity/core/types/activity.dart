...
class Activity extends Quantity {
  ...
  static final ActivityUnits becquerels =
      new ActivityUnits("becquerels", null, "Bq", null, 1.0, true);

  /// Accepted for use with the SI, subject to further review.
  static final ActivityUnits curies =
      new ActivityUnits("curies", null, "Ci", null, 3.7e10, false);

  Activity({dynamic Bq, dynamic Ci, double uncert: 0.0})
      : super(Bq != null ? Bq : (Ci != null ? Ci : 0.0), Activity.becquerels,
            uncert);

  Activity._internal(conv)
      : super._dimensions(conv, Activity.activityDimensions);
  ...
  const Activity.constant(Number valueSI,
      {ActivityUnits units, num uncert: 0.0})
