...
class AngularSpeed extends Quantity {
  ...
  AngularSpeed({dynamic rad_per_s, dynamic deg_per_s, double uncert: 0.0}) : super(
          rad_per_s != null ? rad_per_s : (deg_per_s != null ? deg_per_s : 0.0),
...
class AngularSpeedUnits extends AngularSpeed with Units {
  ...
  Units derive(String fullPrefix, String abbrevPrefix, double conv) {
    return new AngularSpeedUnits("${fullPrefix}${name}", _abbrev1 != null ? "${abbrevPrefix}${_abbrev1}" : null,
