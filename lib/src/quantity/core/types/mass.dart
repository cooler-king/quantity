...
class Mass extends Quantity {
  ...
  static const Dimensions massDimensions =
      const Dimensions.constant(const {"Mass": 1});

  /// The standard SI unit.
  static final MassUnits kilograms =
      new MassUnits("kilograms", "kg", null, null, 1.0, false);
  ...
  static final MassUnits grams =
      new MassUnits("grams", "g", null, null, 0.001, true);
  ...
  /// Accepted for use with the SI.
  static final MassUnits unifiedAtomicMassUnits = new MassUnits(
  ...
  Mass({dynamic kg, dynamic g, dynamic au, double uncert: 0.0})
      : super(
            ...
            g != null
                ? Mass.grams
                : (au != null ? Mass.unifiedAtomicMassUnits : Mass.kilograms),
            uncert);
