...
class InformationRate extends Quantity {
  ...
  static final InformationRateUnits bitsPerSecond =
      InformationRateUnits.informationPerTime(Information.bits, Time.seconds);
...
class InformationRateUnits extends InformationRate with Units {
  ...
  /// Constructs an instance from information and time units.
  InformationRateUnits.informationPerTime(InformationUnits iu, TimeUnits tu)
    ...
    abbrev2 = iu.abbrev2 != null && tu.abbrev2 != null
        ? '${iu.abbrev2} ${tu.abbrev2}\u{207b}\u{00b9}'
        : null;
    metricBase = false;
    offset = 0.0;
  }
