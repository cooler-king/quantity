...
class MassFlowRate extends Quantity {
  ...
  static final MassFlowRateUnits kilogramsPerSecond =
      MassFlowRateUnits.massPerTime(Mass.kilograms, Time.seconds);
}
...
class MassFlowRateUnits extends MassFlowRate with Units {
  ...
  /// Constructs an instance based on mass and time units.
  MassFlowRateUnits.massPerTime(MassUnits mu, TimeUnits tu)
    ...
    abbrev2 = mu.abbrev2 != null && tu.abbrev2 != null
        ? '${mu.abbrev2} ${tu.abbrev2}\u{207b}\u{00b9}'
        : null;
    metricBase = false;
    offset = 0.0;
  }
