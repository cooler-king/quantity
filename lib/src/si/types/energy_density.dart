...
class EnergyDensityUnits extends EnergyDensity with Units {
  ...
  /// Constructs an instance based on energy and volume units.
  EnergyDensityUnits.energyPerVolume(EnergyUnits eu, VolumeUnits vu)
    ...
    abbrev1 = eu.abbrev1 != null && vu.abbrev1 != null
        ...
        : null;
    abbrev2 = condenseUnicodeSequences(eu.abbrev2 != null && vu.abbrev2 != null
        ? '${eu.abbrev2} ${vu.abbrev2}\u{207b}\u{00b9}'
        : null);
    metricBase = false;
    offset = 0.0;
  }
