...
class Concentration extends Quantity {
  ...
  static final ConcentrationUnits molesPerCubicMeter =
      ConcentrationUnits.amountPerVolume(
...
class ConcentrationUnits extends Concentration with Units {
  ...
  ConcentrationUnits.amountPerVolume(AmountOfSubstanceUnits asu, VolumeUnits vu)
    ...
    abbrev1 = asu.abbrev1 != null && vu.abbrev1 != null
        ...
        : null;
    abbrev2 = condenseUnicodeSequences(asu.abbrev2 != null && vu.abbrev2 != null
        ? '${asu.abbrev2} ${vu.abbrev2}\u{207b}\u{00b9}'
        : null);
    metricBase = false;
    offset = 0.0;
  }
