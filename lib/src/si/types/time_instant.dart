...
num getLeapSeconds(double tai) {
  ...
  else if (tai >= 1814400035.0) return 36; //  ((2456109.5-2436204.5) * 86400.0 + 35)   [> 1 Jul 2015 0h]
  ...
  else if (tai < 1814400035.0) return 34; // ((2457204.5-2436204.5) * 86400.0) + 35 [< 1 Jul 2015]
