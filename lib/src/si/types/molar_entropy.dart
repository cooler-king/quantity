...
class MolarEntropy extends Quantity {
  ...
  static final MolarEntropyUnits joulesPerMoleKelvin =
      MolarEntropyUnits.energyPerAmountTemperature(
...
class MolarEntropyUnits extends MolarEntropy with Units {
  ...
  /// Constructs an instance from energy, amount of substance and temperature interval units.
  MolarEntropyUnits.energyPerAmountTemperature(
    ...
    abbrev2 = eu.abbrev2 != null && aosu.abbrev2 != null
        ? '${eu.abbrev2} ${aosu.abbrev2}\u{207b}\u{00b9} ${tu.abbrev2}\u{207b}\u{00b9}'
        : null;
    metricBase = false;
    offset = 0.0;
  }
