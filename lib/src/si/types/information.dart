...
class Information extends Quantity {
  ...
  static final InformationUnits bits =
      InformationUnits('bits', 'bit', 'bit', 'bit', 1.0, true);

  /// Equal to 4 bits.
  static final InformationUnits nibbles =
      InformationUnits('nibbles', 'nibble', 'nibble', 'nibble', 4.0, false);

  /// Equal to 8 bits.
  static final InformationUnits bytes =
      InformationUnits('bytes', 'B', 'B', 'byte', 8.0, false);
  ...
  static final InformationUnits tebibytes = InformationUnits(
      'tebibytes', 'TiB', 'TiB', 'tebibyte', 8.0 * 1.099511627776e12, false);
  ...
  static final InformationUnits pebibytes = InformationUnits(
      'pebibytes', 'PiB', 'PiB', 'pebibyte', 8.0 * 1.125899906842624e15, false);
  ...
  static final InformationUnits zebibytes = InformationUnits(
      'zebibytes', 'ZiB', 'ZiB', 'zebibyte', 8.0 * math.pow(2, 70), false);
  ...
  static final InformationUnits yobibytes = InformationUnits(
      'yobibytes', 'YiB', 'YiB', 'yobibyte', 8.0 * math.pow(2, 80), false);
}
