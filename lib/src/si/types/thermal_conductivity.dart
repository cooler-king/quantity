...
class ThermalConductivity extends Quantity {
  ...
  static final ThermalConductivityUnits wattsPerMeterKelvin =
      ThermalConductivityUnits.powerPerLengthTemperature(
...
class ThermalConductivityUnits extends ThermalConductivity with Units {
  ...
  /// Constructs an instance based on power, length and temperature interval units.
  ThermalConductivityUnits.powerPerLengthTemperature(
    ...
    abbrev2 = pu.abbrev2 != null && lu.abbrev2 != null
        ? '${pu.abbrev2} ${lu.abbrev2}\u{207b}\u{00b9} ${tiu.abbrev2}\u{207b}\u{00b9}'
        : null;
    metricBase = false;
    offset = 0.0;
  }
