...
class Pressure extends Quantity {
  ...
  static final PressureUnits pascals =
      PressureUnits('pascals', 'Pa', 'Pa', 'pascal', 1.0, true);

  /// Accepted for use with the SI, subject to further review.
  static final PressureUnits bars =
      PressureUnits('bars', null, null, 'bar', 1.0e5, true);
}
...
class PressureUnits extends Pressure with Units {
  ...
  /// Constructs an instance from force and area units.
  PressureUnits.forcePerArea(ForceUnits fu, AreaUnits au)
    ...
    abbrev1 = fu.abbrev1 != null && au.abbrev1 != null
        ...
        : null;
    abbrev2 = condenseUnicodeSequences(fu.abbrev2 != null && au.abbrev2 != null
        ? '${fu.abbrev2} ${au.abbrev2}\u{207b}\u{00b9}'
        : null);
