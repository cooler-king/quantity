...
class RadiantIntensity extends Quantity {
  ...
  static final RadiantIntensityUnits wattsPerSteradian =
      RadiantIntensityUnits.powerPerSolidAngle(
...
class RadiantIntensityUnits extends RadiantIntensity with Units {
  ...
  /// Constructs an instance based on power nad solid angle units.
  RadiantIntensityUnits.powerPerSolidAngle(PowerUnits pu, SolidAngleUnits sau)
    ...
    abbrev2 = pu.abbrev2 != null && sau.abbrev2 != null
        ? '${pu.abbrev2} ${sau.abbrev2}\u{207b}\u{00b9}'
        : null;
    abbrev2 = condenseUnicodeSequences(abbrev2);
    metricBase = false;
    offset = 0.0;
  }
