...
void registerStandardSIQuantities() {
  registerQuantityType(AbsorbedDose, AbsorbedDose.absorbedDoseDimensions,
  ...
  registerQuantityType(Charge, Charge.electricChargeDimensions,
  ...
  registerQuantityType(Concentration, Concentration.concentrationDimensions,
      (dynamic value, ConcentrationUnits? units, double uncert) =>
          Concentration.inUnits(value, units, uncert));
  registerQuantityType(Conductance, Conductance.electricConductanceDimensions,
      (dynamic value, ConductanceUnits? units, double uncert) =>
          Conductance.inUnits(value, units, uncert));
  registerQuantityType(Currency, Currency.currencyDimensions,
      (dynamic value, CurrencyUnits? units, double uncert) =>
          Currency.inUnits(value, units, uncert));
  registerQuantityType(Current, Current.electricCurrentDimensions,
      (dynamic value, CurrentUnits? units, double uncert) =>
          Current.inUnits(value, units, uncert));
  registerQuantityType(CurrentDensity, CurrentDensity.electricCurrentDensityDimensions,
  ...
  registerQuantityType(DynamicViscosity, DynamicViscosity.dynamicViscosityDimensions,
      (dynamic value, DynamicViscosityUnits? units, double uncert) =>
          DynamicViscosity.inUnits(value, units, uncert));
  registerQuantityType(ElectricFieldStrength, ElectricFieldStrength.electricFieldStrengthDimensions,
  ...
  registerQuantityType(ElectricPotentialDifference, ElectricPotentialDifference.electricPotentialDifferenceDimensions,
  ...
  registerQuantityType(MagneticFlux, MagneticFlux.magneticFluxDimensions,
      (dynamic value, MagneticFluxUnits? units, double uncert) =>
          MagneticFlux.inUnits(value, units, uncert));
  registerQuantityType(MagneticFluxDensity, MagneticFluxDensity.magneticFluxDensityDimensions,
  ...
  registerQuantityType(MassDensity, MassDensity.massDensityDimensions,
      (dynamic value, MassDensityUnits? units, double uncert) =>
          MassDensity.inUnits(value, units, uncert));
  registerQuantityType(MassFlowRate, MassFlowRate.massFlowRateDimensions,
  ...
  registerQuantityType(Scalar, Scalar.scalarDimensions,
      (dynamic value, ScalarUnits? units, double uncert) =>
          Scalar.inUnits(value, units, uncert));
  registerQuantityType(SolidAngle, SolidAngle.solidAngleDimensions,
      (dynamic value, SolidAngleUnits? units, double uncert) =>
          SolidAngle.inUnits(value, units, uncert));
  registerQuantityType(SpecificEnergy, SpecificEnergy.specificEnergyDimensions,
  ...
  registerQuantityType(TimeInstant, TimeInstant.timeInstantDimensions,
      (dynamic value, TimeInstantUnits? units, double uncert) =>
          TimeInstant.inUnits(value, units, uncert));
  registerQuantityType(Torque, Torque.torqueDimensions,
      (dynamic value, TorqueUnits? units, double uncert) =>
          Torque.inUnits(value, units, uncert));
  registerQuantityType(Volume, Volume.volumeDimensions,
  ...
  registerQuantityType(WaveNumber, WaveNumber.waveNumberDimensions,
